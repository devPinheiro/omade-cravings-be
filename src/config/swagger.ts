...
const swaggerOptions: swaggerJSDoc.Options = {
  ...
  apis: process.env.NODE_ENV === 'production' 
    ...
    : [
        ...
        './src/domains/products/routes/productRoutes.ts',
        './src/domains/cart/routes/cartRoutes.ts',
        './src/domains/cart/routes/enhancedCartRoutes.ts',
        './src/domains/order/routes/orderRoutes.ts',
        './src/domains/reviews/routes/reviewRoutes.ts',
        './src/domains/loyalty/routes/loyaltyRoutes.ts',
        './src/domains/promo/routes/promoRoutes.ts',
        './src/domains/custom-cake/routes/customCakeRoutes.ts',
        './src/domains/notifications/routes/notificationRoutes.ts',
      ],
};
