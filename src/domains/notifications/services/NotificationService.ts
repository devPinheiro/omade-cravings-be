...
export class NotificationService {
  ...
  async sendOrderPreparing(
    ...
    return this.sendNotification({
      ...
      context,
      type: NotificationType.EMAIL, // Email for order preparation updates
    });
  }
  ...
  async sendPaymentConfirmation(
    ...
    return this.sendNotification({
      ...
      context,
      type: NotificationType.EMAIL, // Email for payment confirmations
    });
  }
  ...
  private async sendEmailNotification(
    ...
    switch (event) {
      ...
      case NotificationEvent.ORDER_PREPARING:
        return this.emailService.sendOrderPreparing(email, context);
      ...
      case NotificationEvent.PAYMENT_CONFIRMED:
        return this.emailService.sendPaymentConfirmation(email, context);
      default:
